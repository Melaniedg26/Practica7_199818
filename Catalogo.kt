...
class Catalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_catalogoo)
    ...
    fun cargarSeries() {
        ...
        series.add(
            Pelicula(
                ...
                " Geralt de Rivia, un cazador de monstruos mutante, viaja en pos de su destino por un mundo turbulento en el que, a menudo, los humanos son peores que las bestia  "
                ,arrayListOf<Cliente>())
        )
